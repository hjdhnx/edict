...
echo "下一步："
echo "  1. 配置当前主栈环境变量:"
echo "     cd edict && cp .env.example .env"
echo "     # 按需设置 DISPATCH_BACKEND、ASTRBOT_API_URL、ASTRBOT_API_KEY"
echo "  2. 启动当前 Docker Compose 主栈:"
echo "  3. 启动服务:          cd edict && docker compose up -d --build"
echo "  4. 打开总控台:        http://127.0.0.1:7899"
echo ""
